...
public class QueryUtil {
	...
	public static String  insertEmployeeQuery() {
		return "INSERT INTO EMPLOYEE_INFO(EMPLOYEE_NAME,EMPLOYEE_ADDRESS,EMPLOYEE_SALARY,PHONE_NO)VALUES (?,?,?,?)";
	}
    ...
    public static String updateEmployeeQuery(int employeeId) {
    	return "UPDATE EMPLOYEE_INFO SET EMPLOYEE_NAME = ?, EMPLOYEE_ADDRESS=?, EMPLOYEE_SALARY =?, PHONE_NO = ? WHERE EMPLOYEE_ID = "+employeeId;
